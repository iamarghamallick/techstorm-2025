export const roterrance = {
    ...
    registrationLink: "Ro-terrance it's an event where your bot has to cross different kinds of terrain and hurdles to reach the final destination. The bot has to be manually controlled and can be both wired and wireless.",
    ...
    rules: [
        {
            ...
            "content": [
                ...
                "The maximum time allotted for completing the arena is 6 minutes.",
                "The arena will contain obstacles like sand, bumpers, water, and a net-bridge. Water depth: 3-4 cm (motors will not be fully submerged).",
                "No restarts and no skips are allowed.",
                "Each team gets one technical timeout of 2 minutes in case of electronic failures (solder/motor issues). No timeout for track belt/wheel changes.",
        ...
        },
        {
            ...
            "content": [
                "The dimension of the bot must not exceed 30 × 30 cm (no tolerance) at the start of the event.",
