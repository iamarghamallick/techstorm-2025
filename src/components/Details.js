...
const Details = () => {
    return (
        <div className='p-2 py-8 flex flex-col md:flex-row gap-8 justify-center items-center'>
            <div className={`${righteous.className} date-time-container flex flex-col justify-center items-center relative pr-10 mr-10`}>
                {/* Vertical Line */}
            ...
            <div className='map-container rounded-xl w-[80%]'>
                <GoogleMap />
            </div>

            <div className={`${righteous.className} date-time-container flex flex-col gap-6`}>
                ...
                <h1 className='text-6xl text-[#63B1FF]'>B. P. Poddar Institute of Management and Technology</h1>
