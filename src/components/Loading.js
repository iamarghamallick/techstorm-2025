...
export default function Loading() {
    ...
    return (
        <div
            className={`fixed top-[60px] md:top-24 inset-0 flex flex-col items-center justify-center bg-gradient-to-b from-[#1E1336] to-gray-800 overflow-hidden transition-all duration-500 ease-out ${fadeOut ? "opacity-0 scale-90" : "opacity-100 scale-100 z-[9999]"
                }`}
        >
